...
import com.app.ecommerce.service.UserDetailsServiceImpl;
    ...
    SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
    	...
    	http
	        .authorizeHttpRequests((auth) -> auth
	                ...
	                .requestMatchers(HttpMethod.PUT, "/produtos").hasAnyAuthority("ADMIN")
	                .requestMatchers(HttpMethod.DELETE, "/produtos/{id}").hasAnyAuthority("ADMIN")
	                .requestMatchers(HttpMethod.PUT, "/produtos/reativar/{id}").hasAnyAuthority("ADMIN")
